...
public class ProfileActivity extends AppCompatActivity {
        ...
        if (user != null) {
            ...
            // Nếu có avatar thì set cho imgAvatar
            if (imgAvatar != null && user.getAvatarPath() != null && !user.getAvatarPath().isEmpty()) {
                imgAvatar.setImageURI(android.net.Uri.parse(user.getAvatarPath()));
            }
        }
    }
			...
			private void setupClickListeners() {
						...
						if (imgAvatar != null) imgAvatar.setOnClickListener(v -> openImagePicker());
						if (btnEditProfile != null) btnEditProfile.setOnClickListener(v -> Toast.makeText(this, "Edit Profile feature coming soon!", Toast.LENGTH_SHORT).show());
						if (btnManageAddress != null) btnManageAddress.setOnClickListener(v -> Toast.makeText(this, "Address Management feature coming soon!", Toast.LENGTH_SHORT).show());
						if (btnAddAddress != null) btnAddAddress.setOnClickListener(v -> Toast.makeText(this, "Add Address feature coming soon!", Toast.LENGTH_SHORT).show());
						if (layoutMyOrders != null) layoutMyOrders.setOnClickListener(v -> Toast.makeText(this, "My Orders feature coming soon!", Toast.LENGTH_SHORT).show());
						if (layoutWishlist != null) layoutWishlist.setOnClickListener(v -> {
						...
						if (layoutLogout != null) layoutLogout.setOnClickListener(v -> showLogoutDialog());
			}
